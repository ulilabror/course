   ...
   <body>
            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-light">
               ...
               <div class="collapse navbar-collapse" id="navbarSupportedContent">
                  ...
                  <form class="form-inline my-2 my-lg-0">
                     <div class="login_text"><a href="admin/login">Login</a></div>
      ...
      <div class="footer_section">
         <div class="container">
            ...
            <div class="call_main">
               <div class="call_text"><img src="images/call-icon.png"><span class="padding_left_15">WA 082283839409</span></div>
               <div class="call_text"><img src="images/mail-icon.png"><span class="padding_left_15">mcc@umk.ac.id</span></div>
            </div>
